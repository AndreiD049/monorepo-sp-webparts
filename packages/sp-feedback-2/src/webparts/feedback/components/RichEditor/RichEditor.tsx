...
import { ChoiceGroup, Dialog, DialogType, Icon } from 'office-ui-fabric-react';
...
const ImageDialog: React.FC<{ isOpen: boolean; onDismiss: () => void }> = (
    props
) => {
    ...
    return (
        <Dialog
            ...
            title="Attach file"
            subText="You can attach a file from you local system, or provide an Url to an image."
            dialogContentProps={{
    ...
    return (
        <div className={styles.container}>
            ...
            <ImageDialog
                ...
                onDismiss={() => setFileDialogOpen(false)}
            />
        </div>
    );
};
