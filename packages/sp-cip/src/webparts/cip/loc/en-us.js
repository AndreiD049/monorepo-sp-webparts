define([], function() {
  return {
    ...
    "CipTasksListDescription": "The name of the list where the cip tasks will be stored",
    "CipCommentListLabel": "Comment list name",
    "CipCommentListDescription": "The name of the list where all the comments are stored",
