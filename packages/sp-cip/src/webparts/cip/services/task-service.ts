...
import { ICreateTask } from '../tasks/ICreateTask';
import { ITaskOverview, LIST_EXPAND, LIST_SELECT } from '../tasks/ITaskOverview';
import { isFinished } from '../tasks/task-utils';
...
export class TaskService {
    ...
    constructor(tennantKey: string = 'Data', listTitle: string) {
        this.sp = CipWebPart.SPBuilder.getSP(tennantKey);
