...
export const MsdsForm: React.FC<IMsdsFormProps> = (props: IMsdsFormProps) => {
    ...
    return (
        <div className={styles.formContainer}>
            ...
            <div style={{ display: 'flex', flexFlow: 'row nowrap', gap: '.5em', alignItems: 'center' }}>
                <Logo
                    style={{
                        marginLeft: '2.5em',
                        marginTop: '.5em',
                ...
                />
                <Text variant='medium'> – Fields that will affect PLATO</Text>
            </div>
            <form
                    ...
                    >
                        ...
                        <div className="width-20p">
                            <MSDSCheckbox
                                ...
                                rules={{
                                    disabled:
                                        field.PackedOperations === 'Disabled',
                                }}
                            />
                        </div>
                    </div>
                        ...
                        <div className="width-20p">
                            <MSDSTextField
                                ...
                                rules={{
                                    ...
                                    disabled:
                                        disabledFields.indexOf('MeltingPoint') >
                                            -1 ||
                                        field.MeltingPoint === 'Disabled',
                                }}
                            />
                        </div>
                    </div>
                    ...
                    >
                        <div className="width-15p">
                            <MSDSCheckbox
                                ...
                                rules={{
                                    disabled:
                                        disabledFields.indexOf('Abrasive') >
                                            -1 || field.Abrasive === 'Disabled',
                                }}
                                icon={
                                    <Logo
                                        style={{
                        ...
                        <div className="width-20p">
                            <MSDSCheckbox
                                ...
                                rules={{
                                    disabled:
                                        disabledFields.indexOf('Hygroscopic') >
                                            -1 ||
                                        field.Hygroscopic === 'Disabled',
                                }}
                                icon={
                                    <Logo
                                        style={{
                    ...
                    <div className={`${styles.msdsRow} ${styles.msdsGap1}`}>
                        ...
                        <div className="width-20p">
                            <MSDSCheckbox
                                ...
                                rules={{
                                    disabled:
                                        field.ForbiddenForBulk === 'Disabled',
                                }}
                                icon={
                                    <Logo
                                        style={{
                        ...
                        <div className="width-20p">
                            <MSDSSpinButton
                                ...
                                rules={{
                                    disabled:
                                        disabledFields.indexOf('BulkDensity') >
                                            -1 ||
                                        field.BulkDensity === 'Disabled',
                                }}
                                icon={
                                    <Logo
                                        style={{
                    ...
                    >
                        ...
                        <div className="width-20p">
                            <MSDSCheckbox
                                ...
                                rules={{
                                    disabled:
                                        field.ManipNotAllowed === 'Disabled',
                                }}
                                icon={
                                    <Logo
                                        style={{
                    ...
                    >
                        ...
                        <div className="width-20p">
                            <MSDSCheckbox
                                ...
                                rules={{
                                    disabled:
                                        field.NitrogenCoverage === 'Disabled',
                                }}
                                icon={
                                    <Logo
                                        style={{
                    ...
                    >
                        ...
                        <div className="width-20p">
                            <MSDSCheckbox
                                ...
                                rules={{
                                    disabled:
                                        field.ExtraCheckNeeded === 'Disabled',
                                }}
                                icon={
                                    <Logo
                                        style={{
